...
# 文件路径列表
file_paths = [
    'SHAP_values_train_Amine_R.csv',
    'SHAP_values_train_Aromatic_R.csv',
    'SHAP_values_train_Ether_R.csv',
    'SHAP_values_train_Halogen_R.csv',
    'SHAP_values_train_Hydroxyl_R.csv',
    'SHAP_values_train_Ketone_Aldehyde_R.csv',
    'SHAP_values_train_Nitrile_R.csv',
    'SHAP_values_train_Other_R.csv',
    'SHAP_values_train_Thioether_R.csv',
    'SHAP_values_train_Thiol_R.csv'
]
