...
# 加载原始数据
file_path = 'imputed_selected_features_Flam.csv'  # 替换为你原始数据集的路径
...
# 你提供的前四个最重要特征（假设是前四个）
top_features = ["MorganFingerprints", "AATS3m", "MATS6s", "SpMax1_Bhm"]  # 替换为实际的特征名称
# 重新训练模型以获取特征重要性
...
# 创建输出目录
output_dir_ice = 'Out_result_Flam_ICE_re'
...
for i in feature_indices:
    ...
    # 设置标题
    axes[plot_index].set_title(f"Flammability in RF", fontsize=14, fontweight='bold')
